...
- **الخطوة التالية المطلوبة من المستخدم**: من تبويب "الأرقام" بلوحة الإدارة، اضغط "ربط الآن" لإدخال WABA ID + Access Token مرة واحدة (إن لم تُدخل من قبل)، ثم أضف أي رقم عميل بإدخال رقم الهاتف فقط. لتفعيل الرقم المشترك: اضغط "تحديد الرقم المشترك" في نفس التبويب وأدخل رقم الهاتف الذي سيخدم عملاء باقات "مشترك"، وتأكد من ضبط `number_mode = shared` على الباقة المناسبة من تبويب "الباقات"
- **آخر تحديث**: 2026-08-18 (دعم الرقم المشترك متعدد المكاتب — Multi-tenant: باقات بنمط "مشترك" تستخدم رقم واتساب واحد للمنصة، وربط تلقائي للمكاتب عبر رسالة "اسم المكتب تفعيل")
