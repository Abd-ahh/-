...
- `GET/PUT/DELETE /whatsapp-numbers` , `/whatsapp-numbers/:id`
...
- **الخطوة التالية المطلوبة من المستخدم**: من تبويب "الأرقام" بلوحة الإدارة، اضغط "ربط الآن" لإدخال WABA ID + Access Token مرة واحدة (إن لم تُدخل من قبل)، ثم أضف أي رقم عميل بإدخال رقم الهاتف فقط
- **آخر تحديث**: 2026-08-17 (تفعيل الأرقام برقم الهاتف فقط — ربط حساب Meta مرة واحدة على مستوى المنصة)
